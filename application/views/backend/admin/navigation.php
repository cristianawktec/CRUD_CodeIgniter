<div class="sidebar-menu">
    ...
    <ul id="main-menu" class="">
        ...
        <li class="<?php if ($page_name == 'manage_cliente') echo 'active'; ?> ">
            <a href="<?php echo base_url(); ?>index.php?admin/cliente">
                <i class="fa fa-user"></i>
                <span><?php echo get_phrase('Clientes'); ?></span>
            </a>
        </li>
        ...
        <li class="<?php if ($page_name == 'system_settings' || $page_name == 'manage_language' ||
            ...
            <a href="#">
                ...
                <span><?php echo get_phrase('Configurações'); ?></span>
            </a>
            <ul>
                <li class="<?php if ($page_name == 'system_settings') echo 'active'; ?> ">
                    <a href="<?php echo base_url(); ?>index.php?admin/system_settings">
                        <span><i class="fa fa-cog"></i> <?php echo get_phrase('Configurações do Sistema'); ?></span>
                    </a>
                </li>
                <li class="<?php if ($page_name == 'manage_language') echo 'active'; ?> ">
                    <a href="<?php echo base_url(); ?>index.php?admin/manage_language">
                        <span><i class="fa fa-globe"></i> <?php echo get_phrase('Setar Idioma'); ?></span>
                    </a>
                </li>
        ...
        <li class="<?php if ($page_name == 'manage_profile') echo 'active'; ?> ">
            <a href="<?php echo base_url(); ?>index.php?admin/manage_profile">
                <i class="entypo-lock"></i>
                <span><?php echo get_phrase('Conta'); ?></span>
            </a>
        </li>
